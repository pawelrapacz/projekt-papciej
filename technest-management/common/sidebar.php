<div class="sidebar">
    ...
    <nav class="navbar">
        <!-- home, analytics, inventory, orders and accounting -->
        <section class="nav-section">
            <ul>
                <li>
                    <a class="nav-link" href="/technest-management/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M5 22h14a2 2 0 0 0 2-2v-9a1 1 0 0 0-.29-.71l-8-8a1 1 0 0 0-1.41 0l-8 8A1 1 0 0 0 3 11v9a2 2 0 0 0 2 2zm5-2v-5h4v5zm-5-8.59 7-7 7 7V20h-3v-5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v5H5z"></path></svg>
                        <div>Start</div>
                    </a>
                </li>
                <li>
        ...
        <!-- notifications, messages and opinions -->
        <section class="nav-section">
            <ul>
                <li>
                    <a class="nav-link" href="#">
            ...
            <ul>
                <li>
                    <button class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 22c3.976 0 8-1.374 8-4V6c0-2.626-4.024-4-8-4S4 3.374 4 6v12c0 2.626 4.024 4 8 4zm0-2c-3.722 0-6-1.295-6-2v-1.268C7.541 17.57 9.777 18 12 18s4.459-.43 6-1.268V18c0 .705-2.278 2-6 2zm0-16c3.722 0 6 1.295 6 2s-2.278 2-6 2-6-1.295-6-2 2.278-2 6-2zM6 8.732C7.541 9.57 9.777 10 12 10s4.459-.43 6-1.268V10c0 .705-2.278 2-6 2s-6-1.295-6-2V8.732zm0 4C7.541 13.57 9.777 14 12 14s4.459-.43 6-1.268V14c0 .705-2.278 2-6 2s-6-1.295-6-2v-1.268z"></path></svg>
                        <div>Baza danych</div>
                    </button>
                    <?php
                        ...
                        while ($row = $result->fetch_row())
                        {
                            ...
                            echo <<<END
                            <li>
                                <form action="/technest-management/database/" method="get">
                                    <input type="text" name="table" class="none" value="$name" readonly>
                        ...
                        while ($row = $result->fetch_row())
                        {
                            ...
                            <li>
                                <form action="/technest-management/database/" method="get">
                                    <input type="text" name="view" class="none" value="$name" readonly>
                                    <button type="submit" class="nav-link">
        ...
        <section class="nav-section">
            <ul>
                <li>
                    <a class="nav-link" href="/technest-management/settings/">
